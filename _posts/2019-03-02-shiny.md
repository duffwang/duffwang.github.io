...
To demonstrate Shiny, I've created an interactive tool based on the Home Loan dataset I have been using in the previous few posts. I've hosted the tool on shinyapps.io, a convenient Shiny deployment site created by RStudio. This tool allows you to select a demographic profile and see what the home loan market would have been like for them at a particular time in the past. Below, I walk through the code and how it functions so you can begin building your own Shiny app.
