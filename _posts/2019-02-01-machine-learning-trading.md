...
In general, it is difficult if not impossible to beat the market. You could probably can beat the market, for brief periods of time, if you have teams of very smart people working on it full time. For example, famous hedge funds like Renaissance Technologies employ technical strategies, and do exactly that. But a typical retail investor stands little chance against more sophisticated investors, and our cognitive biases make us over-confident in our ability to find patterns in noise. In fact, if the efficient market hypothesis is true, it is impossible to predict future prices with technical analysis.
