...
Building a narrative around data is important for making a convincing argument about what the data shows. The best data narrative should be able to present all arguments succinctly and clearly. In this post, I walk through the construction of a data narrative, starting from the exploration of data and ending with a complete story told by the data. All the code I wrote to analyze and generate plots in R is shown alongside each section.
