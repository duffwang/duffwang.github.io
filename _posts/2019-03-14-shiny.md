...
I separated out my code into the ui and server arguments of the call to runShiny (which, as you may guess, runs the Shiny app). It is shown below commented to explain what each line is doing.
...
Once that is setup, simply call the function to begin the Shiny simulation.
